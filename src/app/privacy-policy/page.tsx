    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50 px-4 sm:px-6 lg:px-8 py-12 font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-cyan-500 mt-4">
            Your Health Data, Our Responsibility
          </h2>
        ...
        <div className="flex justify-center mb-12">
          <motion.div
            ...
            animate={{ scaleX: 1 }}
            transition={{ duration: 0.7, ease: "easeOut" }}
            className="bg-gradient-to-r from-blue-600 via-sky-500 to-cyan-400 rounded-full w-3/4 h-2 shadow-lg hover:scale-105 transition-transform duration-300"
          />
        </div>
        ...
        >
          <Link href="/services">
            <button className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-8 sm:px-10 py-3 rounded-full font-semibold hover:from-blue-700 hover:to-cyan-600 transform hover:scale-105 transition duration-300 shadow-md">
              Explore Services
            </button>
          </Link>
          <Link href="/contact">
            <button className="bg-white border-2 border-blue-600 text-blue-600 px-8 sm:px-10 py-3 rounded-full font-semibold hover:bg-blue-100 hover:border-blue-700 transition duration-300 shadow-md">
              Contact Us
            </button>
          </Link>
        </motion.div>
