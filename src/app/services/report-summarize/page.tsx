  ...
  const summarizeReport = async () => {
    ...
    try {
      ...
      const formattedData: ReportSummaryResponse = {
        ...
        detailed_analysis: data.detailed_analysis || data.summary || 'No detailed analysis available.',
        ...
        disclaimer: data.disclaimer || 'This information is educational only and not medical advice.',
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-blue-400 rounded-full flex items-center justify-center mx-auto mb-6">
            <RiPagesFill className="w-8 h-8 text-white" />
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
            ...
            {result ? (
              <>
                {result.type && (
                  <div className="mb-6">
                    <h3 className="text-lg font-semibold text-gray-700 mb-3">Report Type:</h3>
                ...
                {result.detailed_analysis && (
                  <div className="mb-6">
                    <h3 className="text-lg font-semibold text-gray-700 mb-3">Detailed Analysis:</h3>
